...
<div class="page-content">
    <section class="greeting-section fade-in">
        ...
        <p class="greeting-subtitle">Here is your submitted work.</p>
    </section>
    ...
    <a href="<?= url('report/add') ?>" class="quick-action fade-in" aria-label="Add today's work report">
    ...
    <div class="empty-state fade-in">
        ...
        <a href="<?= url('report/add') ?>" class="btn btn-primary" aria-label="Add your first report">Add Today's Work</a>
    </div>
    <?php else: ?>
    ...
    <div class="report-list fade-in">
        ...
        <a href="<?= url('report/' . $report['id']) ?>" class="report-card" aria-label="View report for <?= e(formatDate($report['work_date'])) ?>">
