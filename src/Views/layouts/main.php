    ...
    <div class="app-container">
        ...
        <aside class="sidebar" aria-label="Main navigation">
            ...
            <nav class="sidebar-nav">
                <a href="<?= url('home') ?>" class="sidebar-nav-item <?= ($activeNav ?? '') === 'home' ? 'active' : '' ?>" aria-label="Home">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                    <span>Home</span>
                </a>
                <a href="<?= url('report/add') ?>" class="sidebar-nav-item <?= ($activeNav ?? '') === 'add' ? 'active' : '' ?>" aria-label="Add Work Report">
            ...
            <div class="sidebar-footer">
                <button class="sidebar-footer-item" id="sidebarThemeToggle" aria-label="Toggle theme">
