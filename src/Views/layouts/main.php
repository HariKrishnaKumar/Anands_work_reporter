...
<body>
    <div class="app-container">
        <?php if (isLoggedIn() && ($showHeader ?? true)): ?>
        <aside class="sidebar" aria-label="Main navigation">
            <a href="<?= url('home') ?>" class="sidebar-logo" aria-label="Home">
                ...
                <span>Yajurvedh Work Report</span>
            </a>

            <nav class="sidebar-nav">
                <a href="<?= url('home') ?>" class="sidebar-nav-item <?= ($activeNav ?? '') === 'home' ? 'active' : '' ?>" aria-current="<?= ($activeNav ?? '') === 'home' ? 'page' : 'false' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                    <span>Home</span>
                </a>
                <a href="<?= url('report/add') ?>" class="sidebar-nav-item <?= ($activeNav ?? '') === 'add' ? 'active' : '' ?>" aria-current="<?= ($activeNav ?? '') === 'add' ? 'page' : 'false' ?>">
            ...
            <div class="sidebar-footer">
                <button class="theme-switcher sidebar-theme-switcher" role="switch" aria-checked="false" aria-label="Toggle theme" tabindex="0">
                ...
                <a href="<?= url('logout') ?>" class="sidebar-footer-item logout-item" aria-label="Logout">
        ...
        <div class="main-area">
            ...
            <header class="app-header">
                ...
                <div class="header-actions">
                    <?php if (isLoggedIn()): ?>
                    <button class="theme-switcher header-theme-switcher" role="switch" aria-checked="false" aria-label="Toggle theme" tabindex="0">
                        <div class="theme-switcher-icons">
                            <svg class="icon-sun" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
                            <svg class="icon-moon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                        </div>
